...
The version sequence skips **V12, which was never issued**. The gap is history,
not a missing file; Flyway does not require consecutive numbers and
`flyway_schema_history` records exactly the files that exist.
